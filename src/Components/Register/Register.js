    ...
    render(){
        ...
        let pageStatus = 
                <div>
                    ...
                    <h2 className="animated fadeInLeftBig"> Registration </h2>
                    </div>
                    <br></br>
                    ...
                    <form onSubmit={this.submitDataHandler}>
                            <fieldset>
                                ...
                                <select style={{height: '45px'}} value={this.state.value.genderValue} onChange={(event) => this.valueChangeHandler(event, 1)}>
                            ...
                            <fieldset>
                                    ...
                                    <select style={{height: '45px'}}  value={this.state.value.venueValue} onChange = {(event) => this.valueChangeHandler(event, 11)}>
                                    ...
                                    <select style={{height: '45px'}}  value={this.state.value.dateValue} onChange={(event) => this.valueChangeHandler(event, 12)}>
                            ...
                            <fieldset>
                                    ...
                                    <select style={{height: '45px'}}  value={this.state.value.modeOfPayValue} onChange = {(event) => this.valueChangeHandler(event, 13)}>
