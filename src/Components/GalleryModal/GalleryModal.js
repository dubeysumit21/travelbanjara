            ...
            return(
                    <div className={classes.galleryModal}>
                        ...
                        <div className={classes.galleryComponents}>
                            ...
                            <div className={classes.imageHolder}><img className={classes.images} src={this.state[this.props.id].imageArray[this.state[this.props.id].counter]} alt="image1" /></div>
